...
inline void Softmax(Stream<gpu> *s, DType *in, DType *out,
  ...
  hipLaunchKernel(HIP_KERNEL_NAME(softmax_compute_kernel<x_bits, OP, DType, ndim>), dim3(N), dim3(x_size), 0, mshadow::Stream<gpu>::GetStream(s), 
...
inline void SoftmaxGrad(Stream<gpu> *s, DType *out, DType *ograd,
  ...
  hipLaunchKernel(HIP_KERNEL_NAME(softmax_gradient_kernel<x_bits, OP1, OP2, DType, ndim>), dim3(N), dim3(x_size), 0, mshadow::Stream<gpu>::GetStream(s), 
